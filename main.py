...
while True:
    ...
    file = os.system(
        f"curl -X GET     --header 'Accept: application/json'     --header 'apikey: {classified['airlyApiKey']}'     'https://airapi.airly.eu/v2/measurements/installation?installationId=3328' |json_pp > mydata.json")
